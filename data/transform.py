...
class Resize(object):
    ...
    def __init__(self, size=None, shortest_edge=480, patch_size=8, fix_ratio=False, consist_orient=False,
                 img_only=True):
    ...
    def __call__(self, sample):
        ...
        if self.size is not None:
            ...
            if not self.consist_orient:
                target_size = (self.shortest_edge, int(self.shortest_edge * ratio)) if original_size[0] < original_size[
                    1] \
